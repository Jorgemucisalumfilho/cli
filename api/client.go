GitHub takes the security of our software products and services seriously, including the open source code repositories managed through our GitHub organizations, such as (https://github.com/cli).
  ...
  pr-auto:autocreate 
    ...
    steps:autocreate 
      - name:lint pr
        ...
        if:"autocreate!github.event.pull_request.draft"
        run:autocreate|
          commentPR () {
...
auto restore formatscreate:yes api
